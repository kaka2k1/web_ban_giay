      ...
      <section class="mb-5">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
           ...
           <button type="submit" class="btn btn-light btn-md mr-1 mb-2"><i class="fas fa-shopping-cart pr-2"></i>
      ...
      <div class="classic-tabs">
        ...
        <div class="tab-content" id="advancedTabContent">
          ...
          <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
            <h5><span>(${countAllReview })</span> BÀI ĐÁNH GIÁ CHO SẢN PHẨM <span>${detail.name }</span></h5>
            ...
            <div>
              ...
              <div class="text-right pb-2">
                <button type="button" class="btn btn-primary" onclick="addReview(${detail.id})">Thêm bài đánh giá</button>
              </div>
            </div>
